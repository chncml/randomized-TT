...
for k = 1:length(kk)
    ...
    for sample = 1 : 10
        sample
        [Q, T1] = randomizedTTGaussian(A, TTr, 5, 0);AT1(k, sample) = T1;
        ...
        [Q, T2] = randomizedTTGaussian(A, TTr, 10, 0);AT2(k, sample) = T2;
        ...
        [Q, T3] = randomizedTTGaussian(A, TTr, 15, 0);AT3(k, sample) = T3;
        ...
        [Q, T4] = randomizedTTGaussian(A, TTr, 20, 0);AT4(k, sample) = T4;
        ...
        [Q, T5] = randomizedTTKR(A, TTr, 5, 0);AT5(k, sample) = T5;
        ...
        [Q, T6] = randomizedTTKR(A, TTr, 10, 0);AT6(k, sample) = T6;
        ...
        [Q, T7] = randomizedTTKR(A, TTr, 15, 0);AT7(k, sample) = T7;
        ...
        [Q, T8] = randomizedTTKR(A, TTr, 20, 0);AT8(k, sample) = T8;
        ...
        [Q, T9] = prandomizedTTeven(A, TTr, 5, 1);AT9(k, sample) = T9;
        ...
        [Q, T10] = prandomizedTTeven(A, TTr, 10, 1);AT10(k, sample) = T10;
        ...
        [Q, T11] = prandomizedTTeven(A, TTr, 15, 1);AT11(k, sample) = T11;
        ...
        [Q, T12] = prandomizedTTeven(A, TTr, 20, 1);AT12(k, sample) = T12;
