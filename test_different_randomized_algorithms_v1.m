function test_different_randomized_algorithms_v1
...
for k = 1:length(kk)
    ...
    for sample = 1 : 10
        ...
        [Q, T3] = randomizedTTKR(A, TTr, 10, 0);AT3(k, sample) = T3;
        ...
        [Q, T4] = randomizedTTKR(A, TTr, 10, 1);AT4(k, sample) = T4;
        ...
        [Q, T5] = prandomizedTTeven(A, TTr, 10, 1);AT5(k, sample) = T5;
        ...
        [Q, T6] = prandomizedTTeven(A, TTr, 10, 2);AT6(k, sample) = T6;
...
%         
        ...
        [Q, T9] = randomizedTTexisting2(A, TTr, 10, 0);AT9(k, sample) = T9;
        ...
        [Q, T10] = randomizedTTexisting2(A, TTr, 10, 1);AT10(k, sample) = T10;
