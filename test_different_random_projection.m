function test_different_random_projection
%% different random projection: Gaussian, KR-Gaussian, Kron-Gaussian and SpEmb
clc;clear;nn = [50, 50, 50, 50, 50];
AT1 = [];AT2 = [];AT3 = [];AT4 = [];
AT5 = [];AT6 = [];AT7 = [];AT8 = [];
AT9 = [];AT10 = [];AT11 = [];AT12 = [];
AERR1 = [];AERR2 = [];AERR3 = [];AERR4 = [];
AERR5 = [];AERR6 = [];AERR7 = [];AERR8 = [];
AERR9 = [];AERR10 = [];AERR11 = [];AERR12 = [];
P = 20;
tic
...
for k = 1:length(kk)
    ...
    for sample = 1 : 10
        ...
        [Q, T7] = randomizedTTSpEmb(A, TTr, 10, 0);AT7(k, sample) = T7;
        ...
        [Q, T8] = randomizedTTSpEmb(A, TTr, 10, 1);AT8(k, sample) = T8;
        ...
        [Q, T9] = randomizedTTKron(A, TTr, 10, 0);AT9(k, sample) = T9;
        ...
        [Q, T10] = randomizedTTKron(A, TTr, 10, 1);AT10(k, sample) = T10;
        ...
        [Q, T11] = randomizedTTDCT(A, TTr, 10, 0);AT11(k, sample) = T11;
        ...
        [Q, T12] = randomizedTTDCT(A, TTr, 10, 1);AT12(k, sample) = T12;
...
plot(kk,sum(AERR3,2)/sample,'-o','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR4,2)/sample,':o','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR5,2)/sample,'-d','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR6,2)/sample,':d','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR7,2)/sample,'-s','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR8,2)/sample,':s','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR9,2)/sample,'-*','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR10,2)/sample,':*','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR11,2)/sample,'-x','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AERR12,2)/sample,':x','LineWidth',2,'MarkerSize',10);hold on;
...
plot(kk,sum(AT3,2)/sample,'-o','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT4,2)/sample,':o','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT5,2)/sample,'-d','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT6,2)/sample,':d','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT7,2)/sample,'-s','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT8,2)/sample,':s','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT9,2)/sample,'-*','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT10,2)/sample,':*','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT11,2)/sample,'-x','LineWidth',2,'MarkerSize',10);hold on;
plot(kk,sum(AT12,2)/sample,':x','LineWidth',2,'MarkerSize',10);hold on;
xlabel('P (number of indices)');
ylabel('CPU time');
set(gca, 'fontsize', 20);
figure(2);
...
semilogy(kk,sum(AT3,2)/sample,'-o','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT4,2)/sample,':o','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT5,2)/sample,'-d','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT6,2)/sample,':d','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT7,2)/sample,'-s','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT8,2)/sample,':s','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT9,2)/sample,'-*','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT10,2)/sample,':*','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT11,2)/sample,'-x','LineWidth',2,'MarkerSize',10);hold on;
semilogy(kk,sum(AT12,2)/sample,':x','LineWidth',2,'MarkerSize',10);hold on;
xlabel('P (number of indices)');
ylabel('CPU time');
set(gca, 'fontsize', 20);
...
% plot(beta, 1 - sum(AERR7,2)/sample,'-s','LineWidth',2,'MarkerSize',10);hold on;
...
% plot(beta, 1 - sum(AERR11,2)/sample,'-x','LineWidth',2,'MarkerSize',10);hold on;
% plot(beta, 1 - sum(AERR12,2)/sample,':x','LineWidth',2,'MarkerSize',10);hold on;
% xlabel('P (number of indices)');
% ylabel('RLNE');
% set(gca, 'fontsize', 20);
% subplot(1,2,2);
...
% plot(beta, sum(AT7,2)/sample,'-s','LineWidth',2,'MarkerSize',10);hold on;
...
% plot(beta, sum(AT11,2)/sample,'-x','LineWidth',2,'MarkerSize',10);hold on;
% plot(beta, sum(AT12,2)/sample,':x','LineWidth',2,'MarkerSize',10);hold on;
% xlabel('P (number of indices)');
% ylabel('CPU time');
% set(gca, 'fontsize', 20);
% figure(4);
...
% semilogy(beta, sum(AT7,2)/sample,'-s','LineWidth',2,'MarkerSize',10);hold on;
...
% semilogy(beta, sum(AT11,2)/sample,'-x','LineWidth',2,'MarkerSize',10);hold on;
% semilogy(beta, sum(AT12,2)/sample,':x','LineWidth',2,'MarkerSize',10);hold on;
% xlabel('P (number of indices)');
% ylabel('CPU time');
% set(gca, 'fontsize', 20);
end